...
parser.add_argument('--Xgrad_lambda', dest='Xgrad_lambda', type=float, default=200.0, help='weight on X-direction gradient loss term in objective')
parser.add_argument('--Ygrad_lambda', dest='Ygrad_lambda', type=float, default=200.0, help='weight on Y-direction gradient loss term in objective')
